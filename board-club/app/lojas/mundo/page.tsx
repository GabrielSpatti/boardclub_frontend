...
export default function MundoGeekPage() {
  ...
  const loja = {
    nome: "Mundo Geek & Tabuleiro",
    cidade: "Belo Horizonte/MG",
    descricao:
      "O Mundo Geek é um espaço amplo e familiar em Belo Horizonte, ideal para encontrar tanto jogos de tabuleiro quanto colecionáveis. Eles são especialistas em receber a comunidade e facilitar retiradas de jogos.",
    endereco: "Praça dos Dados, 50 - Bairro Novo",
    horario: "Terça a Domingo: 14h às 21h. Segunda: Fechado.",
    contato: "parceria@mundogeekbh.com.br",
    linkMaps: "http://googleusercontent.com/maps.google.com/3...", // Link fictício
  };
